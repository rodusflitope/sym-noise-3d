...
def build_model(cfg):
    ...
    if name == "epsilon_mlp":
    ...
    elif name == "pointtransformer_true_joint_multiplane_dit_legacy":
        ...
        return PointTransformerTrueJointMultiplaneDiTLegacy(
            hidden_dim=hidden_dim,
            time_dim=time_dim,
            num_planes=num_planes,
            num_heads=num_heads,
    ...
    elif name == "pointtransformer_true_joint_multiplane_dit":
        ...
        return PointTransformerTrueJointMultiplaneDiT(
            hidden_dim=hidden_dim,
            time_dim=time_dim,
            num_planes=num_planes,
            num_heads=num_heads,
    ...
    elif name == "pointtransformer_true_joint_multiplane_relative_dit":
        ...
        return PointTransformerTrueJointMultiplaneRelativeDiT(
            hidden_dim=hidden_dim,
            time_dim=time_dim,
            num_planes=num_planes,
            num_heads=num_heads,
