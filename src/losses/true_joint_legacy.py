...
class TrueJointSymmetryPlaneLossLegacy:
    def __init__(
        self,
...
def build_true_joint_symmetry_plane_loss_legacy(cfg: dict) -> TrueJointSymmetryPlaneLossLegacy:
    loss_cfg = cfg.get("loss", {})
    model_cfg = cfg.get("model", {}) or {}
    joint_cfg = cfg.get("joint_symmetry", {}) or {}
    weighting = str(loss_cfg.get("weighting", "none")).lower()
    return TrueJointSymmetryPlaneLossLegacy(
